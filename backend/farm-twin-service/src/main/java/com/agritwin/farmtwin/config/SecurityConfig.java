...
import com.agritwin.farmtwin.security.JwtAuthenticationFilter;
...
/**
 * Every endpoint here requires a valid access token minted by user-service —
 * there is no local login. See JwtTokenValidator for why this service can
 * only verify, never issue, tokens.
 */
@Configuration
@EnableWebSecurity
public class SecurityConfig {
     ...
     * Unauthorized instead, matching user-service's behaviour and what
     * callers correctly expect for "no token was sent."
     */
    @Bean
